...
- Location: tests/bloque-b/anulacion.spec.ts:413:7
...
Call log:
  ...
  - waiting for locator('[id$=\'txtAllCheckin\']')
    61 × locator resolved to <input type="text" value="25/09/2026" data-date-format="dd/mm/yyyy" id="ctl00_cphMain_txtAllCheckin" name="ctl00$cphMain$txtAllCheckin" class="form-control date-picker backColor img-dpicker-init coustomtour-form-date"/>
