...
- Location: tests/bloque-a/tarifario.spec.ts:867:7
...
- generic [ref=f2e1]:
  - generic [ref=f2e2]:
                  ...
                  - generic [ref=f2e227]:
                    ...
                    - generic:
                      ...
                      - list:
                        ...
                        - listitem: "• Temporada: enero a mayo, agosto a diciembre"
                  - generic [ref=f2e232]:
                    - generic [ref=f2e233]: 
                    - generic:
                      - strong: Almuerzo
                      - list:
                        - listitem: El almuerzo no está incluido, hay parada en restaurante
                  - generic [ref=f2e234]:
                    - generic:
                      - strong: Bebidas
                      - list:
                        - listitem: Bebidas a cargo del pasajero durante la navegación
                  - link "Ver Detalle " [ref=f2e235] [cursor=pointer]:
                    - /url: javascript:void(0);
                    - text: Ver Detalle
                    - generic [ref=f2e236]: 
              - button "" [ref=f2e238] [cursor=pointer]
            - paragraph [ref=f2e241]:
              - link "Ver Tarifario " [ref=f2e242] [cursor=pointer]:
                - /url: javascript:void(0);
                - text: Ver Tarifario
                - generic [ref=f2e243]: 
          - text:                                                                           
    - complementary
    - generic [ref=f2e247]:
      - generic [ref=f2e248]: AMV. TRAVEL
      - generic [ref=f2e249]:
        - generic [ref=f2e250]:
          - generic [ref=f2e251]: 
          - text: Avenida Córdoba 673 1°B
        - link " 54 11 50313060" [ref=f2e252] [cursor=pointer]:
          - /url: tel:54 11 50313060
          - generic [ref=f2e253]: 
          - text: 54 11 50313060
        - link "hello@amv.travel" [ref=f2e254] [cursor=pointer]:
          - /url: mailto:hello@amv.travel
    - text:       
  - dialog [ref=f2e258]:
    - generic [ref=f2e259]:
      - heading [level=2] [ref=f2e260]: Tu carrito
      - button [ref=f2e261] [cursor=pointer]:
        - generic [ref=f2e262]: 
    - generic [ref=f2e264]:
      - generic [ref=f2e265]: 
      - generic [ref=f2e266]: Tu carrito está vacío
      - generic [ref=f2e267]: Buscá hoteles, excursiones o traslados y los vas a ver acá.
    - text: 
  - text:          
```
